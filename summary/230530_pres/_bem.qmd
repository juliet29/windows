...
def show_single_trace(obj, current_trace_name, width=1000, showlegend=True):
    fig = obj.plot_analysis()

    # only show the traces of items NOT in the list 
    names = ["Observed Temp", "Smoothed", "Difference", "Deriv1", "Deriv2"]
    ...
    fig.update_layout(autosize=False, width=width, height=500,)
    return fig
